...
use App\Dao\DynamicQueryBuilder;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Doctrine\DBAL\Query\QueryBuilder;

class BaseDao implements BaseInterface
{
    protected $container;
    ...
    {
        $dynamicQueryBuilder = $this->container->get('App\Dao\DynamicQueryBuilder');
        return  $dynamicQueryBuilder->setConditions($conditions);
    }
